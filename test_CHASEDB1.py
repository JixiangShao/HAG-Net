...
from src import UNet,ResNetUNet,VGG16UNet,MobileV3Unet,MMUNet,SegNet,R2U_Net,NestedUNet,get_fcn_model,create_ce_net,UNet_HLAEM,UNet_HLAEM_GNN,HAG_Net
...
save_pred = True
save_dir = "results_CHASEDB1/test_pred_HAG_Net"  # 预测图像保存目录（如需修改可同步调整）
